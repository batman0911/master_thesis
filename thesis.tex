...
\isthesis{
    title={PHƯƠNG PHÁP TÌM KIẾM LÂN CẬN RỘNG THÍCH ỨNG \\ CHO MỘT SỐ LỚP BÀI TOÁN ĐỊNH TUYẾN PHƯƠNG TIỆN},
    sub-title={Chuyên ngành: Khoa học dữ liệu \\ Mã số: 8904648.01QTD},
    ...
    submission-date={HÀ NỘI, 2024}, % The date you handed in your document: Format yyyy-mm-dd
    primary-logo={assets/HUSlogo.png}, % Uses the FAU logo by default
...
\begin{document}
    ...
    \begin{content}
        ...
        \input{sections/search/search.tex}
